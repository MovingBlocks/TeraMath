...
public class Vector2i extends BaseVector2i {
     ...
     */
    public Vector2i(org.joml.Vector2i other) {
     ...
     */
    public Vector2i(org.joml.Vector2f vector) {
     ...
     */
    public Vector2i(org.joml.Vector2f vector, RoundingMode rm) {
     ...
     */
    @Deprecated
    public Vector2i(org.joml.Vector2f vector, double offset) {
        this(DoubleMath.roundToInt(vector.x() + offset, RoundingMode.FLOOR),
            DoubleMath.roundToInt(vector.y() + offset, RoundingMode.FLOOR));
    }
     ...
     * @return this
     */
    public Vector2i add(org.joml.Vector2i other) {
        this.x += other.x();
        this.y += other.y();
        return this;
    }
     ...
     * @return this
     */
    public Vector2i sub(org.joml.Vector2i other) {
        this.x -= other.x();
        this.y -= other.y();
        return this;
    }
     ...
     * @param other
     */
    public void min(org.joml.Vector2i other) {
     ...
     * @param other
     */
    public void max(org.joml.Vector2i other) {
