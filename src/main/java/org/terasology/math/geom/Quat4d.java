...
public abstract class Quat4d {
     ...
     */
    public static final MutableQuat4d interpolate(Quat4d q1, Quat4d q2, double alpha) {
        ...
        return new MutableQuat4d(x, y, z, w);
    }
