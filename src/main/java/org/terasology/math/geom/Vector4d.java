...
public class Vector4d extends BaseVector4d {
     ...
     */
    public Vector4d(org.joml.Vector4d other) {
     ...
     * @return this
     */
    public Vector4d set(org.joml.Vector4d other) {
        this.x = other.x;
        this.y = other.y;
        this.z = other.z;
        this.w = other.w;
     ...
     * @return this
     */
    public Vector4d add(org.joml.Vector4d other) {
        this.x += other.x;
        this.y += other.y;
        this.z += other.z;
        this.w += other.w;
     ...
     * @return this
     */
    public Vector4d sub(org.joml.Vector4d other) {
        this.x -= other.x;
        this.y -= other.y;
        this.z -= other.z;
        this.w -= other.w;
     ...
     */
    public final void sub(org.joml.Vector4d t1, org.joml.Vector4d t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
        this.w = t1.w - t2.w;
     ...
     * @param other
     */
    public void min(org.joml.Vector4d other) {
     ...
     * @param other
     */
    public void max(org.joml.Vector4d other) {
