...
public class Vector3d extends BaseVector3d {
     ...
     */
    public Vector3d(org.joml.Vector3d other) {
     ...
     * @return this
     */
    public Vector3d add(org.joml.Vector3d other) {
        this.x += other.x();
        this.y += other.y();
        this.z += other.z();
        return this;
     ...
     * @return this
     */
    public Vector3d sub(org.joml.Vector3d other) {
        this.x -= other.x();
        this.y -= other.y();
        this.z -= other.z();
        return this;
     ...
     */
    public final void sub(org.joml.Vector3d t1, org.joml.Vector3d t2) {
        this.x = t1.x - t2.x;
        this.y = t1.y - t2.y;
        this.z = t1.z - t2.z;
    }
     ...
     * @param other
     */
    public void min(org.joml.Vector3d other) {
     ...
     * @param other
     */
    public void max(org.joml.Vector3d other) {
     ...
     */
    public final Vector3d cross(org.joml.Vector3d v1, org.joml.Vector3d v2) {
    ...
    */
   public final Vector3d parallelComponent(org.joml.Vector3d direction, org.joml.Vector3d normal) {
       set(normal);
    ...
    */
   public final Vector3d perpendicularComponent(org.joml.Vector3d direction, org.joml.Vector3d normal) {
