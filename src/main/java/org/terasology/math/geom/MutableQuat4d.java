 ...
 */
public class MutableQuat4d extends Quat4d {
     ...
     */
    public MutableQuat4d(Quat4d other) {
        this.x = other.getX();
        this.y = other.getY();
        this.z = other.getZ();
        this.w = other.getW();
     ...
     */
    public MutableQuat4d(double x, double y, double z, double w) {
     ...
     */
    public MutableQuat4d(Tuple4d t) {
     ...
     */
    public MutableQuat4d(Vector3d axis, double angle) {
     ...
     */
    public MutableQuat4d(double yaw, double pitch, double roll) {
     ...
     */
    public final void conjugate(MutableQuat4d q1) {
        this.x = -q1.x;
        this.y = -q1.y;
        this.z = -q1.z;
        this.w = q1.w;
    ...
    /**
      ...
      */
    public final void mul(MutableQuat4d q1) {
    ...
    /**
      ...
      * @param q1 the other quaternion
      */
    public final void mulInverse(MutableQuat4d q1) {
        MutableQuat4d tempQuat = new MutableQuat4d(q1);
