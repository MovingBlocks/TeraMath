...
public class Vector3f extends BaseVector3f {
     ...
     */
    public Vector3f(org.joml.Vector3f other) {
     ...
     * @return this
     */
    public Vector3f set(org.joml.Vector3f other) {
        this.x = other.x();
        this.y = other.y();
        this.z = other.z();
        return this;
     ...
     * @return this
     */
    public Vector3f add(org.joml.Vector3f other) {
        this.x += other.x();
        this.y += other.y();
        this.z += other.z();
        return this;
     ...
     * @return this
     */
    public Vector3f sub(org.joml.Vector3f other) {
        this.x -= other.x();
        this.y -= other.y();
        this.z -= other.z();
        return this;
     ...
     */
    public final void sub(org.joml.Vector3f t1, org.joml.Vector3f t2) {
        this.x = t1.x() - t2.x();
        this.y = t1.y() - t2.y();
        this.z = t1.z() - t2.z();
    }
     ...
     * @param other
     */
    public void min(org.joml.Vector3f other) {
     ...
     * @param other
     */
    public void max(org.joml.Vector3f other) {
     ...
     */
    public final Vector3f cross(org.joml.Vector3f v1, org.joml.Vector3f v2) {
     ...
     */
    public final Vector3f reflect(org.joml.Vector3f direction, org.joml.Vector3f normal) {
        set(normal);
    ...
    */
   public final Vector3f parallelComponent(org.joml.Vector3f direction, org.joml.Vector3f normal) {
       set(normal);
    ...
    */
   public final Vector3f perpendicularComponent(org.joml.Vector3f direction, org.joml.Vector3f normal) {
